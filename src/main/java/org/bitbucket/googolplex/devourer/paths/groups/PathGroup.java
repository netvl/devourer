 ...
 * {@link org.bitbucket.googolplex.devourer.paths.patterns.ExtendedPathPattern}. For example, the group can wrap an instance of {@code Set&lt;SimplePath&gt;} and just
 * return the same path if it is present in the set. Other strategies are possible too.
 */
public interface PathGroup {
    Optional<ExtendedPathPattern> lookup(ExtendedPathPattern path);
}
